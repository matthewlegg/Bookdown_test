...
The following existing races are playable:

Players Handbook (5.5e): Human, Halfling, Elf, Aasimar, Tiefling, Gnome 

Mordenkainen's Monsters of the Multiverse: Fire Genasi, Air Genasi, Water Genasi, Goblin, Hobgoblin, Kenku, Kobold, Tabaxi, Triton, Gith, Tortle, Changeling, Eladrin, Harengon, Shadar Kai

Ravenloft: Dhampir, Hexblood, Reborn

Plasmoid

Heliana's Races (some of)

Grim Hollow Races (maybe?)
...
**Breath Weapon Adept.** You gain the Sorcerous Burst cantrip. This version of the cantrip has a range of 60ft, always deals the damage type of your Breath Weapon and requires verbal components only. Constitution is your spellcasting ability for this spell.
[(Requires: All Chromatic, All Metallic, Moonstone or Shadow Ancestry)]{.grey-annotation}
