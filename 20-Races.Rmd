...
Starting at 5th level, you can cast the enlarge / reduce spell with this trait, without requiring a material component or a spell slot. When casting the spell using this trait, you can only target yourself, and the duration is extended to up to one hour. Once you cast that spell with this trait, you can’t do so again until you finish a long rest. You can also cast it using any spell slots you have of 2nd level or higher.
